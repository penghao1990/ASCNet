...
class AnchorHeadMulti(AnchorHeadTemplate):
    ...
    def make_multihead(self, input_channels):
        ...
        for rpn_head_cfg in rpn_head_cfgs:
            ...
            rpn_head = SingleHead(
                self.model_cfg, rpn_head_cfg['IN_CHANNEL'],
    ...
    def forward(self, data_dict):
        ...
        spatial_features_2X = data_dict['spatial_features_2X']
        spatial_features_4X = data_dict['spatial_features_4X']
        spatial_features_8X = data_dict['spatial_features_8X']
        ...
        ret_dicts.append(self.rpn_heads[0](spatial_features_8X))
        ret_dicts.append(self.rpn_heads[1](spatial_features_2X))
        ret_dicts.append(self.rpn_heads[2](spatial_features_4X))
